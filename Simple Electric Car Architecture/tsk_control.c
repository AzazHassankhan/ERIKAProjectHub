...
const RTE_eventTable_t RTE_eventActivationTable_tsk_control[] = {
    { CONTROL_control_run, ev_joystick_onData },  //Manual Driving function in first step
    { BRAKE_Lights_run, ev_target_speed_onData },  //to activate the brake lights
}; 
...
/*
* description: Run Control algorithm
* events: ev_target_speed_onData|ev_joystick_onData
...
TASK(tsk_control)
{
    ...
    while(1)
    {
        ...
        WaitEvent(ev_target_speed_onData|ev_joystick_onData);
