...
*/
 enum eBlinker{
  BLINKER_RIGHT,    /**< \brief Right Blinker */
  BLINKER_LEFT,     /**< \brief Left Blinker */
} ;
typedef enum eBlinker BLINKER_Id_t;
...
*/
struct sBlinker {
    BLINKER_Id_t    led;                /**< \brief Reference to the LED */
    uint8_t         remainingBlinks;    /**< \brief Remaining Blinks */
    boolean_t       emergency;          /**< \brief Emergency flag */
};
typedef struct sBlinker BLINKER_t;
...
//The global blinker objects
extern BLINKER_t BLINKER_left;
extern BLINKER_t BLINKER_right;
